        ...
        <Autocomplete
          ...
          renderInput={(params) => {
            ...
            return (
                            <TextField
                {...params}
                placeholder={data.setPhim ? "" : "Chọn Phim"}
                variant="standard"
                ...
                InputProps={{
                  ...
                  startAdornment: (
                    <>
                      <span style={{display: 'flex', justifyContent: 'center', alignItems: 'center', minWidth: 24, minHeight: 24, borderRadius: '50%', backgroundColor: '#e87722', color: 'white', marginRight: 8, fontSize: 14, fontWeight: 'bold'}}>1</span>
